...
public class PlayerVsPlayer extends AppCompatActivity implements View.OnClickListener {
    ...
    public Coordinates selectedPiece;
    public int check;
    ...
    private void initializeBoard() {
        ...
        Board[4][7].setPiece(WQueen);
        Board[3][7].setPiece(WKing);
        ...
        Board[4][0].setPiece(BQueen);
        Board[3][0].setPiece(BKing);
