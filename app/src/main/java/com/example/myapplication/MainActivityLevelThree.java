...
public class MainActivityLevelThree extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initializeBoard() {
        ...
        Board[5][0].setPiece(BRook1);
        Board[7][1].setPiece(BPawn2);
        Board[6][2].setPiece(BPawn1);


        Board[3][4].setPiece(WBishop1);
        Board[6][6].setPiece(WKing);

        Board[6][5].setPiece(WPawn8);
        Board[6][4].setPiece(WKnight1);
        Board[6][0].setPiece(BKing);
