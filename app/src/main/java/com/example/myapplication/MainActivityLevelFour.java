...
public class MainActivityLevelFour extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initializeBoard() {
        ...
        Board[0][0].setPiece(BQueen);
        Board[4][0].setPiece(BKing);


        Board[7][7].setPiece(WRook1);
        Board[4][2].setPiece(WKing);
