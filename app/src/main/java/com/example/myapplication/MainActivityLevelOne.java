...
public class MainActivityLevelOne extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initializeBoard() {
        ...
        Board[0][0].setPiece(WQueen);
        Board[6][6].setPiece(WKing);


        Board[3][4].setPiece(BQueen);
        Board[4][5].setPiece(BKing);

        Board[3][6].setPiece(BPawn8);
