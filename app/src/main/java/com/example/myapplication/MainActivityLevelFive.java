...
public class MainActivityLevelFive extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initializeBoard() {
        ...
        Board[6][7].setPiece(BRook1);
        Board[0][4].setPiece(BKing);


        Board[3][0].setPiece(WRook1);
        Board[1][2].setPiece(WKing);

        Board[1][5].setPiece(BPawn1);
        Board[1][6].setPiece(WBishop1);
